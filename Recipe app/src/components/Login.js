    ...
    <div className="login-container flex justify-center items-center h-screen bg-gradient-to-r from-green-400 via-blue-500 to-purple-600">
      ...
      >
        ...
        <Button
          title="Login"
          btnType="submit"
          containerStyle="bg-gradient-to-r from-green-400 to-blue-500 text-white px-6 py-3 rounded-full hover:from-blue-500 hover:to-green-400 transition-all duration-300 shadow-lg hover:shadow-2xl"
        />
      </form>
    </div>
  );
...
const fakeLoginAPI = async (data) => {
  return new Promise((resolve) => {
    setTimeout(() => {
      if (data.email === '123@gmail.com' && data.password === '12345') {
